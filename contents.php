...
<?php
$rsJournal = new WA_MySQLi_RS("rsJournal",$localhost,1);
$rsJournal->setQuery("SELECT * FROM journal ORDER BY journal.journalID Desc");
$rsJournal->execute();?><?php
if("" === ""){
	$WA_journals_1699874007477 = new WA_Include("plugins/journals.php");
	require($WA_journals_1699874007477->BaseName);
	$WA_journals_1699874007477->Initialize(true);
}?><?php
if("" === ""){
	$WA_info_1699882671190 = new WA_Include("plugins/info.php");
	require($WA_info_1699882671190->BaseName);
	$WA_info_1699882671190->Initialize(true);
}
?>
<!doctype html>
...
<div class="container" id="mainContent">
  <div class="row" id="mainContentRow">
    <div class="col-xl-8" id="leftContentCol"><!-- InstanceBeginEditable name="leftContentCol" -->
			...
			<?php echo((isset($WA_journals_1699874007477))?$WA_journals_1699874007477->Body:"") ?>
    ...
    <div class="col-xl-4" id="rightContentCol"><!-- InstanceBeginEditable name="rightContentCol" --><?php echo((isset($WA_info_1699882671190))?$WA_info_1699882671190->Body:"") ?><!-- InstanceEndEditable --></div>
</div>
</div>
<br>
