...
<?php
if("" === ""){
	$WA_info_1699882053902 = new WA_Include("../plugins/info.php");
	require($WA_info_1699882053902->BaseName);
	$WA_info_1699882053902->Initialize(true);
}
?><!doctype html>
<html>
<head>
...
<div class="container" id="mainContent">
  <div class="row" id="mainContentRow">
    <div class="col-xl-8" id="leftContentCol"><!-- TemplateBeginEditable name="leftContentCol" -->Content goes here<!-- TemplateEndEditable --></div>
    <div class="col-xl-4" id="rightContentCol"><!-- TemplateBeginEditable name="rightContentCol" -->Content goes here<!-- TemplateEndEditable --></div>
</div>
</div>
<br>
